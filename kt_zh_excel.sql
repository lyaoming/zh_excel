...
Source Server         : location_mysql
Source Server Version : 80016
Source Host           : localhost:3306
Source Database       : kt_zh_excel

Target Server Type    : MYSQL
Target Server Version : 80016
File Encoding         : 65001

Date: 2020-02-14 18:11:59
*/
...
CREATE TABLE `cost_record` (
  `c_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '记录ID',
  `p_id` int(11) NOT NULL COMMENT '人员ID',
  `in_date` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '入院日期',
  `out_date` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '发票或出院日期',
  `classion` int(11) NOT NULL COMMENT '类型',
  `all_selfcost` double(255,2) NOT NULL COMMENT '个人缴付',
  `self_cost` double(255,2) NOT NULL COMMENT '自付',
  `base_num` double(255,2) NOT NULL COMMENT '补充医疗基数',
  `m_factor` double(255,2) NOT NULL COMMENT '补充医疗系数',
  `m_cost` double(255,2) NOT NULL COMMENT '补充医疗报销额',
  `m_nocost` double(255,2) NOT NULL COMMENT '补充医疗不报销额',
  `ma_self` double(255,2) NOT NULL COMMENT '重疾自付基数',
  `ma_reduce` double(255,2) NOT NULL COMMENT '重疾报销额',
  `cost_all` double(255,2) NOT NULL COMMENT '合计报销',
  `ac_cost` double(255,2) NOT NULL COMMENT '实际自付',
  `pev_ma` double(255,2) NOT NULL COMMENT '上次重疾累计',
  `now_ma` double(255,2) NOT NULL COMMENT '本次重疾累计',
  `out_macount` double(255,2) NOT NULL COMMENT '省外重疾计算',
...
-- ----------------------------
-- Table structure for major_disease
-- ----------------------------
DROP TABLE IF EXISTS `major_disease`;
CREATE TABLE `major_disease` (
  `i_id` int(11) NOT NULL AUTO_INCREMENT,
  `i_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '名称',
  `min` double(255,2) NOT NULL COMMENT '最小值',
  `max` double(255,2) NOT NULL COMMENT '最大值',
  `i_factor` double NOT NULL COMMENT '系数',
  PRIMARY KEY (`i_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of major_disease
-- ----------------------------

-- ----------------------------
-- Table structure for medical_factor
-- ----------------------------
DROP TABLE IF EXISTS `medical_factor`;
CREATE TABLE `medical_factor` (
  `d_id` int(11) NOT NULL AUTO_INCREMENT,
  `d_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '名称',
  `d_factor` double NOT NULL COMMENT '系数',
  PRIMARY KEY (`d_id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of medical_factor
-- ----------------------------
...
CREATE TABLE `personnel` (
  ...
  `p_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '姓名',
  `p_department` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '部门',
  `p_status` int(11) DEFAULT NULL COMMENT '状态',
  `p_number` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`p_id`),
  KEY `p_status` (`p_status`),
  CONSTRAINT `personnel_ibfk_1` FOREIGN KEY (`p_status`) REFERENCES `personnel_status` (`s_id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of personnel
-- ----------------------------
INSERT INTO `personnel` VALUES ('4', '21', '121', null, '211');
INSERT INTO `personnel` VALUES ('5', '1', '121', '4', '22');

-- ----------------------------
-- Table structure for personnel_status
-- ----------------------------
DROP TABLE IF EXISTS `personnel_status`;
CREATE TABLE `personnel_status` (
  `s_id` int(11) NOT NULL AUTO_INCREMENT,
  `s_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '人员状态',
  PRIMARY KEY (`s_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of personnel_status
-- ----------------------------
INSERT INTO `personnel_status` VALUES ('4', '22');
...
-- ----------------------------
INSERT INTO `qrtz_locks_copy` VALUES ('RenrenScheduler', 'STATE_ACCESS');
INSERT INTO `qrtz_locks_copy` VALUES ('RenrenScheduler', 'TRIGGER_ACCESS');
...
INSERT INTO `sys_menu` VALUES ('35', '0', '人员信息管理', 'sys/personnel.html', 'personnel:save,personnel:info,personnel:update,personnel:list,personnel:delete', '1', 'fa fa-user', '0');
INSERT INTO `sys_menu` VALUES ('36', '0', '补充医疗系数', 'sys/medicalfactor.html', 'medicalfactor:list,medicalfactor:save,medicalfactor:info,medicalfactor:update,medicalfactor:delete', '1', 'fa fa-plus-circle', '0');
INSERT INTO `sys_menu` VALUES ('37', '0', '重疾计算系数', 'sys/majordisease.html', 'majordisease:list,majordisease:save,majordisease:info,majordisease:update,majordisease:delete', '1', 'fa fa-heart', '0');
INSERT INTO `sys_menu` VALUES ('38', '0', '人员状态定义', 'sys/personnelstatus.html', 'personnelstatus:save,personnelstatus:list,personnelstatus:info,personnelstatus:update,personnelstatus:delete', '1', null, '0');
INSERT INTO `sys_menu` VALUES ('39', '0', '费用报销登记', 'sys/costrecord.html', 'costrecord:list,costrecord:info,costreord:update,costrecord:delete', '1', 'fa fa-pencil', '0');
INSERT INTO `sys_menu` VALUES ('40', '0', '报销Excel导出', 'sys/expensetable.html', null, '1', 'fa fa-table', '0');
...
INSERT INTO `sys_role` VALUES ('3', '用户', null, '2019-08-21 17:26:30');
...
-- ----------------------------
INSERT INTO `sys_role_menu` VALUES ('47', '1', '36');
INSERT INTO `sys_role_menu` VALUES ('48', '1', '37');
INSERT INTO `sys_role_menu` VALUES ('49', '1', '38');
INSERT INTO `sys_role_menu` VALUES ('50', '1', '39');
INSERT INTO `sys_role_menu` VALUES ('51', '1', '40');
INSERT INTO `sys_role_menu` VALUES ('52', '1', '35');
INSERT INTO `sys_role_menu` VALUES ('53', '3', '36');
INSERT INTO `sys_role_menu` VALUES ('54', '3', '37');
INSERT INTO `sys_role_menu` VALUES ('55', '3', '38');
INSERT INTO `sys_role_menu` VALUES ('56', '3', '39');
INSERT INTO `sys_role_menu` VALUES ('57', '3', '40');
INSERT INTO `sys_role_menu` VALUES ('58', '3', '35');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', '908350381@qq.com', '13612345678', '1', '2016-11-11 11:11:11');
INSERT INTO `sys_user` VALUES ('2', 'pony', '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92', 'pony@vip.qq.com', '13926201111', '1', '2017-01-19 15:49:19');
INSERT INTO `sys_user` VALUES ('8', 'user', 'a9ebb948dee3c444a86ff533f15b1d88feb7cb07eff1dd9182c3ca82d42cbb1f', '1069878616@qq.com', '18566023083', '1', '2019-08-21 17:19:30');
